...
def run3(
    ...
    """
    Runs YOLOv5 detection inference on an input image.
    ...
    return annotator.result(), info_show
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "weights/best1226.pt", help="model path or triton URL")
    parser.add_argument("--source", type=str, default=ROOT / r"fire\images\Frame_No0_video_2_jpg.rf.112bafe72bbbd8eb13ff80ba7f3b27b2.jpg", help="file/dir/URL/glob/screen/0(webcam)")
